...
class ListRelatUs extends StatefulWidget {
  @override
  _ListRelatUsState createState() => _ListRelatUsState();
}

class _ListRelatUsState extends State<ListRelatUs> {
  Future<List> usrelat() async {
    final response =
        await http.get("http://192.168.2.7/seekhealth/relat_usGet.php");
